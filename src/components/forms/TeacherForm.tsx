...
//                 <InputField label="Birthday" type="date" name="birthday" defaultValue={data?.birthday.toISOString().split("T")[0]} register={register} error={errors?.birthday} />
...
//                     </select>
//                     {errors.sex?.message && <p className="text-red-400">{errors.sex.message.toString()}</p>}
//                 </div>

//                 <div className="flex flex-col gap-2 w-full md:w-1/4 ">
//                     <label htmlFor="" className="text-xs text-gray-500">Subjects</label>
...
//                     </select>
//                     {errors.subjects?.message && <p className="text-red-400">{errors.subjects.message.toString()}</p>}
//                 </div>



//                 {/* <div className="flex flex-col gap-2 w-full md:w-1/4 justify-center">
//                     <label htmlFor="img" className="text-xs text-gray-500 flex item-center gap-2 cursor-pointer">
//                         <Image src="/upload.png" alt="" width={28} height={28} />
//                         <span>Upload a Photo</span>
//                     </label>
//                     <input type="file" id="img" {...register("img")} className="hidden" />
//                     {errors.img?.message && <p className="text-red-400">{errors.img.message.toString()}</p>}
//                 </div> */}

//                 <CldUploadWidget uploadPreset="school" onSuccess={(result, { widget }) => { setImg(result.info); widget.close() }}>
//                     {({ open }) => {
//                         return (
//                             <div className="text-xs text-gray-500 flex item-center gap-2 cursor-pointer" onClick={() => open()}>
//                                 <Image src="/upload.png" alt="" width={28} height={28} />
//                                 <span>Upload a Photo</span>
//                             </div>
//                         );
        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <InputField
                    ...
                    type="date"
                    name="birthday"
                    defaultValue={data && data.birthday ? new Date(data.birthday).toISOString().slice(0, 10) : ""}
                    register={register}
