        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex flex-wrap justify-between gap-4">
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 ">
                    <label htmlFor="" className="text-xs text-gray-500">Supervisor</label>
                    ...
                    {errors.supervisorId?.message && <p className="text-red-400">{errors.supervisorId.message.toString()}</p>}
                </div>
