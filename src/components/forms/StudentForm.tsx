    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 ">
                    <label htmlFor="" className="text-xs text-gray-500">Grade</label>
                    ...
                    {errors.gradeId?.message && <p className="text-red-400">{errors.gradeId.message.toString()}</p>}
                </div>
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 ">
                    ...
                    {errors.classId?.message && <p className="text-red-400">{errors.classId.message.toString()}</p>}
                </div>
