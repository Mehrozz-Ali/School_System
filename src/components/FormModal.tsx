...
const FormModal = ({ table, type, data, id, relatedData }: FormContainerProps & { relatedData?: any }) => {
    ...
    return (
        <>
            ...
            {
                open && <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" >
                    <div className="bg-white p-4 rounded-md relative w-full md:w-[70%]  lg:w-[60%] xl:w-[50%] 2xl:w-[40%] max-h-[90vh] overflow-y-auto ">
                        <Form />
